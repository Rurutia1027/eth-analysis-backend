// this is beacon block mock function collection
// we create several mock functions to mock beacon block for tests
...
impl BeaconHeaderSignedEnvelopeBuilder {
    ...
    pub fn parent_header(
        mut self,
        parent_header: &BeaconHeaderSignedEnvelope,
    ) -> Self {
